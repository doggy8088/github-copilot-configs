...
## GitHub Copilot 檔案來源說明

本 Repository 不再每日自動同步 [Awesome GitHub Copilot Customizations](https://github.com/github/awesome-copilot) 的內容，請直接前往 [github/awesome-copilot](https://github.com/github/awesome-copilot) 取得最新檔案與更新資訊。
